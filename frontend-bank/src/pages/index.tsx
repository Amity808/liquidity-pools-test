    ...
    return (
        <>
            <div  className='p-5 md:px-2 sm:px-2 max-sm:px-2 '>
                ...
                <button className=" py-2 px-3 rounded  bg-blue-500 text-white " onClick={() => disconnect()}>
                    Disconnect
                </button>
            </div>
            <main className='p-5'>
        ...
        <button className="py-2 px-3 rounded bg-red-500 text-white" type="submit" disabled={loading} style={{ display: "flex"}}>
        {loading ? (<>
        ...
        <div className="mt-4">
          ...
          className="py-2 px-3 rounded bg-yellow-600 text-white"
          >Withdraw
          </button>
        </div>
